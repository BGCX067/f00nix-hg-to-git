...
class MainWinFrame(wx.Frame):
    ...
    def loadFile(self, event):
        msg = wx.FileDialog(self, message = "Open desired media file", style = wx.OPEN, wildcard = "Media Files|*.wav;*.mp3") # current foronly two formats
...
def main():
    ...
    MainWinFrame(None, inpTitle="f00nix Dev Version - Buggy", inpStyle=wx.MINIMIZE_BOX | wx.SYSTEM_MENU | wx.CAPTION | wx.CLOSE_BOX, inpSize = (800, 800))
    appInst.MainLoop()
